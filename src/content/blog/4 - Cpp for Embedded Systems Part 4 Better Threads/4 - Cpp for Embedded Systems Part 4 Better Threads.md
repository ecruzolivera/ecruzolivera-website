...
- [Current threads APIs](#current-threads-apis)
- [Better Threads](#better-threads)
- [Even Better Threads](#even-better-threads)
- [Even Better Threads: Active Objects](#even-better-threads-active-objects)
- [Conclusions](#conclusions)
<!--toc:end-->

Hi there dear Software/Embedded developers, this is the 4th part of a [blog series](/) about using C++ in software development for microcontrollers.
...
- **Latency**: [Latency](<https://en.wikipedia.org/wiki/Latency_(engineering)#Computer_hardware_and_operating_system_latency>) is a time interval between a stimulus and the response.
...
- **Longevity**: Most current used **RTOS** (Free**RTOS**, VxWorks, QNX, etc) are 10+ years old and when they started to be developed, C was the only real option for embedded software development (except for [Ada](<https://en.wikipedia.org/wiki/Ada_(programming_language)>), but [Ada](<https://en.wikipedia.org/wiki/Ada_(programming_language)>) hasn't taken off in most embedded applications).
